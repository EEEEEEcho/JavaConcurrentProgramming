...
<img src="../pic/2021-08-30_15-38.png" alt="2021-08-30_15-38" style="zoom:150%;" />
...
![2021-08-30_16-29](../pic/2021-08-30_16-29.png)
...
![2021-08-30_16-37](../pic/2021-08-30_16-37.png)
...
![2021-09-01_10-45](../pic/2021-09-01_10-45.png)
...
- 直到小M将烟送来,大叫一声 [ 你的烟到了 ] (调用 notify 方法)，小南重新获得了可以计算的条件(那根烟)
  ...
  ![2021-09-01_10-49](../pic/2021-09-01_10-49.png)

- 小南于是可以离开休息室,重新进入竞争锁的队列，注意，这里是进入竞争队列

![2021-09-01_10-53](../pic/2021-09-01_10-53.png)
...
![2021-09-02_17-08](../pic/2021-09-02_17-08.png)
...
![2021-09-03_11-11](../pic/2021-09-03_11-11.png)
...
![image-20210905171426707](../pic/image-20210905171426707.png)
...
![2021-09-07_17-00](../pic/2021-09-07_17-00.png)
...
![2021-09-07_17-04](../pic/2021-09-07_17-04.png)
...
![2021-09-07_17-07](../pic/2021-09-07_17-07.png)
...
![2021-09-07_17-15](../pic/2021-09-07_17-15.png)
...
![2021-09-08_14-57](../pic/2021-09-08_14-57.png)

![2021-09-08_14-58](../pic/2021-09-08_14-58.png)

![2021-09-08_15-00](../pic/2021-09-08_15-00.png)
...
![image-20210908225349854](../pic/image-20210908225349854.png)

![image-20210908225811527](../pic/image-20210908225811527.png)
...
![image-20210908231151302](../pic/image-20210908231151302.png)
...
![image-20210908231442673](../pic/image-20210908231442673.png)
...
![image-20210912155357473](../pic/image-20210912155357473.png)

主线程执行，唤醒打印A的线程t1

![image-20210912155601438](../pic/image-20210912155601438.png)

注意，这里虽然唤醒了t1,但是t1仍处于WAITING状态，是因为主线程还没有释放锁

继续执行，主线程释放锁

![image-20210912155800045](../pic/image-20210912155800045.png)
...
1. 初始状态， t 线程刚开始从主内存读取了 run 的值到工作内存。
   ![image-20210912165321809](../pic/image-20210912165321809.png)
2.  因为 t 线程要频繁从主内存中读取 run 的值，JIT 编译器会将 run 的值缓存至自己工作内存中的高速缓存中，减少对主存中 run 的访问，提高效率（*所以，刚才出现的那个使用打印语句，会导致线程退出的情况并非Demo有问题，可能是JIT编译器在编译含有打印的代码后，取消了对于高速缓存的使用*）
   ![image-20210912165524645](../pic/image-20210912165524645.png)
3.  1 秒之后，main 线程修改了 run 的值，并同步至主存，而 t 是从自己工作内存中的高速缓存中读取这个变量的值，结果永远是旧值
   ![image-20210912165609863](../pic/image-20210912165609863.png)
...
3: ifnonnull 37		#如果INSTANCE不为NULL,继续。否则跳转至37行
